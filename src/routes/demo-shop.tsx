  ...
  return (
    <>
      <div className="min-h-screen bg-linear-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
        ...
        {/* Powered by Laso Loyalty Badge */}
        <a
          href="https://lasoloyalty.com"
          target="_blank"
          rel="noopener noreferrer"
          className="fixed bottom-6 left-6 z-50 flex items-center gap-2 px-4 py-2.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 group"
        >
          ...
          <svg
            className="w-3.5 h-3.5 text-slate-400 group-hover:text-[#ff5c28] transition-colors"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
